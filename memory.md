...
### 🚧 In progress
- Nothing currently mid-flight. Phase 2 (modules 00–04) and Phase 3's modules (`05`–`07`) are complete. Next in
  phase order: Phase 3's beginner projects B1–B10, or `08-deep-learning` to start Phase 4 — the repository owner's
  call.
