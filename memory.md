...
### 🚧 In progress
- Nothing currently mid-flight. Phase 2 (modules 00–04), Phase 3's modules (`05`–`07`) and `08-deep-learning` are
  complete. Next in phase order: `09-computer-vision`. Phase 3's beginner projects B1–B10 remain open.
- **Known gap:** CLAUDE.md asks for an image-generation prompt in `40-visual-learning/image-prompts/` for every major
  concept; modules 04–08 have none yet.
